	...
	components: [
		...
		components: [
			...
			components: [
					...
					id: "toolbarSidebar",
					components: [
							{tag: "div", classes: "splitToolbarButton toggled", components: [
							{tag: "button", id: "viewThumbnail", classes: "toolbarButton group toggled"},
							{tag: "button", id: "viewOutline", classes: "toolbarButton group"}
						]}
					]},
					{tag: "div", id: "sidebarContent", components: [
						{tag: "div", id: "thumbnailView"},
						{tag: "div", id: "outlineView", classes: "hidden"}
					]}
				]},
				{tag: "div",
				id: "mainContainer",
