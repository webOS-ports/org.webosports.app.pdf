...
require('./lib/pdfjs/external/shelljs/make');
var builder = require('./lib/pdfjs/external/builder/builder.js');
var crlfchecker = require('./lib/pdfjs/external/crlfchecker/crlfchecker.js');
...
target.bundle = function() {
  ...
  var EXT_SRC_FILES = [
        '../lib/pdfjs/external/jpgjs/jpg.js'];
