...
//Herrie Strict disabled for Enyo
//'use strict';
...
var PDFView = {
  ...
  parseScale: function pdfViewParseScale(value, resetAutoSettings, noScroll) {
	...
	//Herrie divide by 100 in case of string since cannot set option value, only content. So value gets in % instead of proper value
    if (typeof value == "string")
	{
		var scale = parseFloat(value)/100;
	}
	else
	{
